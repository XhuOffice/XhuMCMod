...
public class ItemXhuShovel extends ElementsXhumcmodMod.ModElement {
	@GameRegistry.ObjectHolder("xhumcmod:xhu_shovel")
	public static final Item block = null;
	public ItemXhuShovel(ElementsXhumcmodMod instance) {
		super(instance, 8);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("xhumcmod:xhu_shovel", "inventory"));
	}
}
