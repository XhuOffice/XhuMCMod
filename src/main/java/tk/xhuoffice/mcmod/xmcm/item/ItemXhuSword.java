...
public class ItemXhuSword extends ElementsXhumcmodMod.ModElement {
	@GameRegistry.ObjectHolder("xhumcmod:xhu_sword")
	public static final Item block = null;
	public ItemXhuSword(ElementsXhumcmodMod instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("xhumcmod:xhu_sword", "inventory"));
	}
}
