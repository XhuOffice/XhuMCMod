...
import tk.xhuoffice.mcmod.xmcm.item.ItemXhuArmor;
...
public class ProcedureIfXhuArmorGet extends ElementsXhumcmodMod.ModElement {
	public ProcedureIfXhuArmorGet(ElementsXhumcmodMod instance) {
		super(instance, 26);
	}
		...
		if ((((((entity instanceof EntityPlayer) ? ((EntityPlayer) entity).inventory.armorInventory.get(0) : ItemStack.EMPTY)
			...
			if (entity instanceof EntityPlayerMP) {
				Advancement _adv = ((MinecraftServer) ((EntityPlayerMP) entity).mcServer).getAdvancementManager()
						.getAdvancement(new ResourceLocation("xhumcmod:xhu_armor_get"));
